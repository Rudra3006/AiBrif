...
// Robustly parse JSON from AI response, handling markdown fences and partial text
function parseNewsFromText(text) {
  ...
  // Fallback: extract structured news from markdown-style text
  const items = [];
...
// Validate and sanitise a single news item
function sanitiseItem(item) {
  return {
    title: item.title || "Untitled",
    summary: item.summary || "",
    // Ensure URL is a real URL, not a hallucinated placeholder
    url:
      item.url && item.url.startsWith("http") && !item.url.includes("example")
        ? item.url
        : "#",
    category: ["AI", "Stock Market", "Currency", "General"].includes(
      item.category
    )
      ? item.category
      : "General",
...
Example: [{"title":"...","summary":"...","url":"https://...","category":"AI","time":"1h ago"}]`;
      ...
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "user",
              content: `Find and return 9 latest news items about: ${query}`,
            },
          ],
        }),
      });
      ...
      // Collect all text blocks (search results come back across multiple blocks)
      const fullText = data.content
        .filter((b) => b.type === "text")
        .map((b) => b.text)
        .join("\n");

      const raw = parseNewsFromText(fullText);
    ...
    try {
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          tools: [{ type: "web_search_20250305", name: "web_search" }],
          system:
            'Return ONLY a raw JSON object (no markdown, no explanation) with current approximate values: {"btc":"$105,000","sp500":"5,800","nasdaq":"19,200","eurusd":"1.0850","gbpusd":"1.2710"}',
          messages: [
            {
              role: "user",
              content:
                "Get current BTC price, S&P 500, NASDAQ, EUR/USD, GBP/USD rates",
            },
          ],
        }),
      });
      ...
      // Silent fallback for market bar
      setMarketData({
        btc: "$105K",
        sp500: "5,800",
        nasdaq: "19,200",
  ...
  // Reload news when category changes (skip on first render — already loading "All")
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div
              style={{
                width: "32px",
                height: "32px",
                background: "linear-gradient(135deg,#00ffe7,#6366f1)",
                borderRadius: "8px",
                display: "flex",
                alignItems: "center",
      ...
      >
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "14px" }}>
            Real-time intelligence gathered from across the web — curated by AI,
            for you.
          </p>
        </div>
          ...
          {CATEGORIES.map((cat) => (
            <button
              ...
              style={{
                ...
                color:
                  activeCategory === cat ? "#0a0f1e" : "rgba(255,255,255,0.6)",
                border:
                  activeCategory === cat
                    ? "none"
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.4)" }}>
              You are the admin of AIbrif.com. Use the Refresh button to fetch
              latest news at any time. Stories are AI-curated with live web
              search. Links open full articles in new tabs.
            </p>
          </div>
        </div>
      </main>
...
function getFallbackNews(category) {
  const all = [
    {
      title: "OpenAI Launches New Model with Advanced Reasoning Capabilities",
      summary:
        "The new model shows significant improvements in math and coding tasks.",
      url: "https://openai.com/blog",
      category: "AI",
      time: "1h ago",
    },
    {
      title: "S&P 500 Rises as Fed Signals Rate Pause",
      summary:
        "Markets rallied after the Federal Reserve indicated it would hold rates steady.",
      url: "https://finance.yahoo.com",
      category: "Stock Market",
      time: "2h ago",
    },
    {
      title: "EUR/USD Climbs on Positive Eurozone Data",
      summary:
        "The euro gained ground as inflation data came in below expectations.",
    ...
    },
    {
      ...
      summary:
        "New research extends AlphaFold capabilities to drug discovery.",
      url: "https://deepmind.google",
      category: "AI",
      time: "4h ago",
    },
    {
      title: "NASDAQ Hits New High Driven by AI Stocks",
      summary:
        "Technology shares surged as investor enthusiasm for AI continues.",
      url: "https://finance.yahoo.com",
      category: "Stock Market",
      time: "5h ago",
    },
    {
      title: "Bitcoin Holds Above $100K Amid Institutional Demand",
      summary:
        "Crypto markets remain stable as ETF inflows hit monthly record.",
      url: "https://coindesk.com",
      category: "Currency",
      time: "6h ago",
    },
    {
      title: "Anthropic Raises $3B in New Funding Round",
      summary:
        "The AI safety company plans to expand compute and research capabilities.",
      url: "https://anthropic.com",
      category: "AI",
      time: "7h ago",
    },
    {
      title: "UK Pound Strengthens Against Dollar",
      summary:
        "GBP/USD rose following stronger-than-expected employment figures.",
      url: "https://www.reuters.com",
      category: "Currency",
      time: "8h ago",
    },
    {
      title: "Tesla Stock Surges on Robotaxi Launch Date Announcement",
      summary:
        "Shares jumped 12% after the company confirmed a commercial launch.",
      url: "https://finance.yahoo.com",
      category: "Stock Market",
      time: "9h ago",
    },
  ...
  return all
    ...
    .concat(all.filter((n) => n.category !== category))
    .slice(0, 9);
}
